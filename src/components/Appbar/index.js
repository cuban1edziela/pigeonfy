...
export default function ButtonAppBar() {
  ...
  const goToEnciphering = () => {
    history.push('/encipher')
  }
  const goToDeciphering = () => {
    history.push('/decipher')
  }
  const goToContactBook = () => {
      ...
      <AppBar position="static" >
        <Toolbar >
          ...
          <Typography sx={{ position: 'right', p: '30px', flexDirection: 'row', display: 'block', ml: 'auto' }}>
            <Button sx={{ ml: 5 }} variant='text' onClick={goToEnciphering} color="secondary">ENCIPHER</Button>

            <Button sx={{ ml: 5 }} variant='text' onClick={goToDeciphering} color="secondary">DECIPHER</Button>

            <Button sx={{ ml: 5 }} variant='text' onClick={goToContactBook} color="secondary">CONTACT BOOK</Button>
